...
export VMDNOCUDA=1
export VMDNOOPTIX=1
vmd -dispdev text  $(ls -v *pdb  | grep *poses*pdb | head -n 1 ) -e ../../autodock_pipeline/calculate_close_residues.tcl  &> /dev/null
...
vmd -e ../../autodock_pipeline/viewing_results_state.vmd $( ls *poses_[0-9][0-9][0-9]*)
